...
namespace oct::verso::v1::devel
{
	...
	public:
		...
		/**
		* \brief Asigna los parametros del cuerpo
		* \param x posion x en el eje carteciano
		* \param y posion y en el eje carteciano
		* \param mass Masa del cuerpo
		* \param distance distancia del cuerpo al sol
		*/
		void set(int x, int y,float mass, float distance);

		float gravitational(const Body&);
		std::vector<int> gravitational_vector(const Body&);
	...
	struct SolarI : public SDL::Scenary
	{
		SolarI();
